        ...
        <section className='bg-[#FFFCF2] text-[#3D3931] mb-20'>
          ...
          <div className=' w-[80%] m-auto mt-5 leading-10'>
            ...
            <span className='text-3xl'>Book Your Stay:</span> 
              <p className='mt-5'>
              Experience the epitome of luxury and convenience at [Hotel Name]. Book your stay with us today and immerse yourself in a world of unparalleled comfort and hospitality. We eagerly await the opportunity to exceed your expectations and create lasting memories during your visit.
              </p>
